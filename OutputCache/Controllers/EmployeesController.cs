...
namespace OutputCache.Controllers
{
    public class EmployeesController : Controller
    {
       ...
       // [OutputCache(CacheProfile = "1minutecache")]
        ...
        //[ChildActionOnly]
        [PartialCacheAttributes(cacheProfileName:"1minutecache")]
        public string child()
        {
            //System.Threading.Thread.Sleep(3000);
            return "Count of Employees"+db.Employees.Count().ToString()+"@"+DateTime.Now.ToString();
        }
